...
const AveximaLayout = () => {
	return(
		<Html lang="ru">
			<HeadComponent title="Запись алгоритма диагностики доступна!" />
			<Tailwind
        		config={{
				...
				<Body className="[font-family:'Noto_Sans']">
					<Section className="w-[640px] bg-[#f4f7fa] px-0 py-[48px] mx-[auto]">
						<Container className="max-w-[544px] mx-auto">
							<Header header={
								<>
									Запись алгоритма<br /> диагностики доступна!
								</>}
							/>
							...
							<Main>
								<Row className="font-[700] leading-[150%] tracking-[0.01em] text-[#384860]">
									<Column>
										<Container>
											<TextDescriptons textHeader text='Не пропустите алгоритмы диагностики заболеваний влагалища проф. Е.Ф. Кира' />
										</Container>
									</Column>
								</Row>
								...
								<Row className="mt-[30px] tracking-[0.01em] text-[16px] leading-[150%] text-[#384860]">
									<Column>
										<Container>
											<TextDescriptons text='Если Вы не успели ознакомиться с мини-лекцией по современной диагностике, напоминаем она тут:' />
										</Container>
									</Column>
								</Row>
